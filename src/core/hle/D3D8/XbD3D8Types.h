...
const int CXBX_D3DVS_CONSTREG_VREGDEFAULTS_BASE = (X_D3DVS_CONSTREG_COUNT);
const int CXBX_D3DVS_CONSTREG_VREGDEFAULTS_FLAG_BASE = (CXBX_D3DVS_CONSTREG_VREGDEFAULTS_BASE + 16);
const int CXBX_D3DVS_VIEWPORT_SCALE_MIRROR = (CXBX_D3DVS_CONSTREG_VREGDEFAULTS_FLAG_BASE + 4);
const int CXBX_D3DVS_VIEWPORT_OFFSET_MIRROR = (CXBX_D3DVS_VIEWPORT_SCALE_MIRROR + 1);
const int CXBX_D3DVS_FIXEDFUNCSTATE = (CXBX_D3DVS_VIEWPORT_OFFSET_MIRROR + 1);
