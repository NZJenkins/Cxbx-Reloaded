...
const int CXBX_D3DVS_CONSTREG_XBOX_BASE = 0;
const int CXBX_D3DVS_CONSTREG_XBOX_SIZE = X_D3DVS_CONSTREG_COUNT; // == 192

const int CXBX_D3DVS_CONSTVREG_DEFAULT_VALUE_BASE = CXBX_D3DVS_CONSTREG_XBOX_BASE + CXBX_D3DVS_CONSTREG_XBOX_SIZE;
const int CXBX_D3DVS_CONSTVREG_DEFAULT_VALUE_SIZE = X_VSH_MAX_ATTRIBUTES; // == 16

const int CXBX_D3DVS_CONSTVREG_DEFAULT_FLAGS_BASE = CXBX_D3DVS_CONSTVREG_DEFAULT_VALUE_BASE + CXBX_D3DVS_CONSTVREG_DEFAULT_VALUE_SIZE;
const int CXBX_D3DVS_CONSTVREG_DEFAULT_FLAGS_SIZE = X_VSH_MAX_ATTRIBUTES / CXBX_D3DVS_SLOT_SIZE_IN_FLOATS; // == 4

const int CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_BASE = CXBX_D3DVS_CONSTVREG_DEFAULT_FLAGS_BASE + CXBX_D3DVS_CONSTVREG_DEFAULT_FLAGS_SIZE;
const int CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_SIZE = 1;

const int CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_BASE = CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_BASE + CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_SIZE;
const int CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_SIZE = 1;

const int CXBX_D3DVS_FIXEDFUNCSTATE_BASE = 0; // TODO : CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_BASE + CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_SIZE;
