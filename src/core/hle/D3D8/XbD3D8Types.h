...
#define X_D3DFVF_TEXCOORDSIZE1(Index) (X_D3DFVF_TEXTUREFORMAT1 << X_D3DFVF_TEXCOORDSIZE_SHIFT(Index))
#define X_D3DFVF_TEXCOORDSIZE2(Index) (X_D3DFVF_TEXTUREFORMAT2) // No need to shift the value zero (0x000)
#define X_D3DFVF_TEXCOORDSIZE3(Index) (X_D3DFVF_TEXTUREFORMAT3 << X_D3DFVF_TEXCOORDSIZE_SHIFT(Index))
#define X_D3DFVF_TEXCOORDSIZE4(Index) (X_D3DFVF_TEXTUREFORMAT4 << X_D3DFVF_TEXCOORDSIZE_SHIFT(Index))
...
const int CXBX_D3DVS_SLOT_SIZE_IN_FLOATS = 4;
const int CXBX_D3DVS_SLOT_SIZE_IN_BYTES = (sizeof(float) * CXBX_D3DVS_SLOT_SIZE_IN_FLOATS);

// Vertex Shader constant registers, used to pass information to vertex shaders
// TODO co-locate shader workaround constants with shader code
const int CXBX_D3DVS_CONSTREG_XBOX_BASE = 0; // == c(0)
const int CXBX_D3DVS_CONSTREG_XBOX_SIZE = X_D3DVS_CONSTREG_COUNT; // == 192

const int CXBX_D3DVS_ATTRDATA_BASE = CXBX_D3DVS_CONSTREG_XBOX_BASE + CXBX_D3DVS_CONSTREG_XBOX_SIZE; // == c(192)
const int CXBX_D3DVS_ATTRDATA_SIZE = X_VSH_MAX_ATTRIBUTES; // == 16

const int CXBX_D3DVS_ATTRFLAG_BASE = CXBX_D3DVS_ATTRDATA_BASE + CXBX_D3DVS_ATTRDATA_SIZE; // == c(208)
const int CXBX_D3DVS_ATTRFLAG_SIZE = X_VSH_MAX_ATTRIBUTES / CXBX_D3DVS_SLOT_SIZE_IN_FLOATS; // == 4

const int CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_BASE = CXBX_D3DVS_ATTRFLAG_BASE + CXBX_D3DVS_ATTRFLAG_SIZE; // == c(212); See X_D3DSCM_RESERVED_CONSTANT_SCALE
const int CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_SIZE = 1;

const int CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_BASE = CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_BASE + CXBX_D3DVS_VIEWPORT_MIRROR_SCALE_SIZE; // == c(213); See X_D3DSCM_RESERVED_CONSTANT_OFFSET
const int CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_SIZE = 1;

const int CXBX_D3DVS_FIXEDFUNCSTATE_BASE = CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_BASE + CXBX_D3DVS_VIEWPORT_MIRROR_OFFSET_SIZE; // == c(214)
