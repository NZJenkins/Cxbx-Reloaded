...
#include "core\hle\D3D8\Direct3D9\VertexShaderSource.h" // For VertexShaderSource
...
void CxbxRecompileVertexProgram()
{
	...
	DWORD XboxFunctionSize = XboxFunctionSizeInBytes / X_VSH_INSTRUCTION_SIZE / sizeof(DWORD);
	...
	auto vertexShaderKey = g_VertexShaderSource.CreateShader(pXboxFunction, &XboxFunctionSize);

	auto pHostShader = g_VertexShaderSource.GetShader(vertexShaderKey);
