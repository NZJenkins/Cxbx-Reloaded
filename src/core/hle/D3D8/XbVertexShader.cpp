...
bool UseOldShader(const XTL::X_D3DVertexShader* pXboxVertexShader)
{
	return g_LibVersion_D3D8 <= 3948;
}

XTL::X_VERTEXATTRIBUTEFORMAT* CxbxGetVertexShaderAttributes(XTL::X_D3DVertexShader* pXboxVertexShader)
{
