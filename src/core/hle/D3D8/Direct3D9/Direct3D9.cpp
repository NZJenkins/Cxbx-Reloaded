...
void CxbxUpdateHostTextures()
{
	...
	bool bNeedTextureNormalization = pXboxVertexAttributeFormat->Slots[XTL::X_D3DVSDE_POSITION].Format == XTL::X_D3DVSDT_FLOAT4;
	float all_textures_scale[XTL::X_D3DTS_STAGECOUNT * 4];
